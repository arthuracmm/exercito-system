    ...
    return (
        <div className="flex flex-1 h-screen w-full font-josefin">
            ...
            <div className="flex flex-col flex-1 ml-50 bg-zinc-200 overflow-hidden py-6 px-8 gap-1">
                ...
                <div className="flex flex-col w-full mt-2 overflow-y-scroll overflow-x-hidden">
                    <div className="flex items-center w-[99%] text-sm bg-white p-2 rounded-sm border-1 border-zinc-300 outline-none my-2 mx-2">
                        <input
                            type="text"
                    ...
                    {atiradores
                        ...
                        .map((atirador) => (
                            <div key={atirador.nomeguerra} className="flex gap-4 bg-white rounded-lg p-4 m-2 w-[99%] justify-between items-center">
